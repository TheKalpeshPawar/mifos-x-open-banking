...
/**
 * Opens a stream over the beneficiaries store, keyed and cached per account.
 */
internal class BeneficiariesRepositoryImpl(
    private val store: Store<String, List<BeneficiaryItem>>,
    ...
    private companion object {
        const val CACHE_KEY = "beneficiaries:list"
    }
}
