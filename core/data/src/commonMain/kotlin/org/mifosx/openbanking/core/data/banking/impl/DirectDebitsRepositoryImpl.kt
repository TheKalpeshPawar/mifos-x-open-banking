...
/**
 * Opens a stream over the direct-debits store, keyed and cached per account.
 */
internal class DirectDebitsRepositoryImpl(
    private val store: Store<String, DirectDebitsSummary>,
    ...
    private companion object {
        const val CACHE_KEY = "directDebits:mandates"
    }
}
