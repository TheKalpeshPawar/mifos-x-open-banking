 ...
 *
 * Consumed by [org.mifosx.openbanking.core.data.store.RoomSubmitOutbox]. The framework uses this table to
...
interface DraftDao {
     ...
     * Call on app start via [org.mifosx.openbanking.core.store.infra.StoreCacheManager.pruneExpiredDrafts].
     */
    @Query(
