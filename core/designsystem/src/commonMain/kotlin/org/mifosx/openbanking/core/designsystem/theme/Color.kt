...
val secondaryContainerLight = Color(0xFFBCEBE7)
...
val surfaceContainerLight = Color(0xFFF0F1E6)
val surfaceContainerHighLight = Color(0xFFEAECE1)
val surfaceContainerHighestLight = Color(0xFFE2E3D8)

val primaryDark = Color(0xFFB2D188)
val onPrimaryDark = Color(0xFF1F3701)
val primaryContainerDark = Color(0xFF354E16)
val onPrimaryContainerDark = Color(0xFFCDEDA3)
val secondaryDark = Color(0xFFA0CFCB)
val onSecondaryDark = Color(0xFF003735)
val secondaryContainerDark = Color(0xFF1F4E4B)
val onSecondaryContainerDark = Color(0xFFBCEBE7)
...
val surfaceContainerHighDark = Color(0xFF282A24)
val surfaceContainerHighestDark = Color(0xFF33352E)
