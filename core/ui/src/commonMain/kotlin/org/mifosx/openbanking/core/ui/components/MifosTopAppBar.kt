...
import org.mifosx.openbanking.core.designsystem.utils.mirrorIfRtl
...
fun MifosTopAppBar(
    ...
    var titleTextHasOverflow by remember { mutableStateOf(false) }
        ...
        TopAppBar(
            ...
            title = {
                Text(
                    ...
                    overflow = TextOverflow.Ellipsis,
                    modifier = Modifier.testTag("PageTitleLabel"),
                    onTextLayout = { titleTextHasOverflow = it.hasVisualOverflow },
                )
            },
            modifier = modifier.testTag("HeaderBarComponent"),
            actions = actions,
