...
@Composable
internal fun AwaitingStep(onAction: (ConsentCallbackAction) -> Unit, modifier: Modifier = Modifier) {
    Box(
        modifier = modifier.fillMaxSize().testTag("callback_awaiting"),
        ...
        Column(
            ...
            Text(
                stringResource(Res.string.feature_callback_awaiting_body),
