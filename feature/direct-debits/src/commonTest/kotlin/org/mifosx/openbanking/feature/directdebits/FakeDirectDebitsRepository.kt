...
/**
 * Hand-written [DirectDebitsRepository] whose stream the test drives directly.
 *
 ...
 */
class FakeDirectDebitsRepository(
    initial: ScreenState<DirectDebitsSummary> = ScreenState.Loading,
    ...
    /** The account id the view model subscribed with; null until [directDebitsStream] is called. */
    ...
    fun emit(state: ScreenState<DirectDebitsSummary>) {
        states.value = state
    }
    ...
    ): ScreenDataStream<DirectDebitsSummary> {
