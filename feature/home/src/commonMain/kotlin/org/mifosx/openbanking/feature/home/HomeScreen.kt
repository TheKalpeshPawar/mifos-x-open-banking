...
import org.mifosx.openbanking.core.common.formatDecimal
import org.mifosx.openbanking.core.common.formatGrouped
                ...
                ScreenContent(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                        items.take(5).forEach { rawItem ->
                            val coin = rawItem as? org.mifosx.openbanking.core.model.crypto.CoinMarket
                                ?: return@forEach
                            Row(
                                modifier = Modifier.fillMaxWidth(),
                                horizontalArrangement = Arrangement.SpaceBetween,
...
private fun ExchangeRateCard(
    state: ScreenState<org.mifosx.openbanking.core.model.currency.ExchangeRates>,
    onRetry: () -> Unit,
    onSeeAll: () -> Unit,
) {
    Card(modifier = Modifier.fillMaxWidth()) {
