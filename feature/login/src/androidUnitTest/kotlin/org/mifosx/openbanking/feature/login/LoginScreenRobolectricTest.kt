...
/**
 * The login states against the real Android Compose runtime under Robolectric — JVM, no device. The
 * sibling `LoginScreenInstrumentedTest` runs the same assertions on a real device.
 */
