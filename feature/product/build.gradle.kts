...
android {
    namespace = "org.mifosx.openbanking.feature.product"
}
...
kotlin {
    sourceSets {
        commonMain.dependencies {
            ...
            // core:network for NetworkError/NetworkResult — the repository is a one-shot fetch, so the
            // view model classifies the raw result itself instead of consuming a ScreenDataStream.
...
compose {
    resources {
        packageOfResClass = "org.mifosx.openbanking.feature.product.generated.resources"
    }
}
