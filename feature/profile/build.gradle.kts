...
kotlin {
    sourceSets {
        ...
        commonTest.dependencies {
            ...
            // Drives ProfileScreenUiTest headlessly on the JVM. The Robolectric and instrumented
...
/**
 * `ProfileScreenUiTest` lives in commonTest so it also compiles for the native and desktop targets,
 ...
 * the Android side to `ProfileScreenRobolectricTest`, which does declare a runner.
 */
