...
/**
 * Hand-written [ScheduledPaymentsRepository] whose stream the test drives directly.
 *
 ...
 */
class FakeScheduledPaymentsRepository(
    initial: ScreenState<List<ScheduledPaymentItem>> = ScreenState.Loading,
    ...
    /** The account id the view model subscribed with; null until [scheduledPaymentsStream] is called. */
    ...
    fun emit(state: ScreenState<List<ScheduledPaymentItem>>) {
        states.value = state
    }
