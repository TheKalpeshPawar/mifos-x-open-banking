 ...
 * 250 for £250 sent £2.50. `PaymentDraft.amountMinorUnits` is unchanged: the wire still carries
...
internal fun amountProblemOf(
    ...
    return when {
        ...
        comparableBalanceMinorUnits != null && parsed > comparableBalanceMinorUnits ->
            SendMoneyAmountProblem.ExceedsAvailableBalance
